...
KT-1 status: FAIL (`docs/RESULTS-KT1-v3.md`). Void: `docs/RESULTS-KT1-v2.md`, `docs/RESULTS-KT1.md`.
...
KT-1 evaluation: `docs/RESULTS-KT1-v3.md` (FAIL). Void: `docs/RESULTS-KT1-v2.md`, `docs/RESULTS-KT1.md`.
